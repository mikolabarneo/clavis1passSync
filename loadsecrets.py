import os
from onepass_functions import getOPSecret, getOPSecrets, getOPVaults, createUpdateOPSecret
...
def main():
    ...
    for secret in clavisSecrets:
        createUpdateOPSecret(onePassFQDN, onePassVaultId, onePassKey, secret)
